...
import {DomainEntity, Order, OrderStatus, PaginationConfig} from "@livesession-food-workshop-angular/core/model";
...
export class BoOrdersPaginatedService {
  ...
  public updateSortAndPaginationState(sort: Sort, pagination: {
